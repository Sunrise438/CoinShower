<div class="login-blade mt-5 mb-5 p-5 bg-dark bg-gradient text-white fw-bold rounded">
    <div class="row">
    <div class="col-xl-12">
           ...
           <!-- new password -->
            <div class="input-group mb-3">
                ...
                <div class="form-floating">
                    <input type="password" name="npass" id="npass" class="form-control text-white bg-transparent fw-bold" value=""
            ...
            <div class="input-group mb-3">
                <span class="input-group-text bg-transparent fw-bold" id="basic-addon1"><span class="material-icons">lock</span></span>
                <div class="form-floating">
                    <input type="password" name="ncpass" id="ncpass" class="form-control text-white bg-transparent fw-bold" value=""
