<div class="container">
    <div class="sidenav vh-100 bg-transparent bg-opacity-25 bg-gradient border border-2 border border-top-0 border border-bottom-0 border border-start-0" id="admin_nav_side">
