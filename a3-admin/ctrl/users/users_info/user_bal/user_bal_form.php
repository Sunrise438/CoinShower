<button type="button" class="btn btn-outline-primary btn-sm fw-bold" data-bs-toggle="modal" data-bs-target="#changeuserbal">
    <?php echo ucfirst($changeName);?>
</button>

<!-- The Modal -->
<div class="modal" id="changeuserbal">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="users_info?token=<?php echo urlencode($row['uname']);?>" onsubmit="return confirm('Are you sure you want to submit?')">
                    ...
                    <input type="hidden" name="userbal" value="b" required="">
                    <div class="form-floating">
                        <input type="number" class="form-control fw-bold" name="bal" value="0" min="0" step="0.00000001" required="">
