...
if(isset($_SESSION['aemail'])){
    ...
    require '../../../../../view/language/en.php';
     ...
     // claim info
    $sql = "SELECT * FROM faucet_history ORDER BY date DESC LIMIT 20";
    ...
    <table  class="table table-striped table-hover" id="temhis">
        ...
        // output data of each row
            while($row = $result->fetch_assoc()) {
                ...
                echo '<td class="fw-bold text-primary"><a href="history?t=user&token='.urlencode($row["uname"]).'" target="_blank">#'.$row["id"].'</a></td>';
