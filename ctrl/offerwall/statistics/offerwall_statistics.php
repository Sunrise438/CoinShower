<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <h1 class="text-center"><?php echo ucfirst($offerwallName).' '. ucfirst($statisticsName);?></h1>
            <hr>
            ...
            require 'libs/ads/offerwall_ads.php';
            require 'ctrl/offerwall/offerwall_history/offerwall_history_table.php';
