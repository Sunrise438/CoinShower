<?php
$my_code_file = "../view/theme/$themeAction/inc/code/code_shortlinks_bottom.php";
...
<div class="row">
    <div class="col-xl-12">
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']).'?settings=default';?>" enctype="multipart/form-data">
            ...
            <div class="mt-3 mb-3">
                <h3 class="form-label fw-blod"><?php echo ucfirst($enterName).' '.ucfirst($shortlinksName).' '.ucfirst($bottomName).' '. ucfirst($codeName).' '. ucfirst($hereName);?></h3>
